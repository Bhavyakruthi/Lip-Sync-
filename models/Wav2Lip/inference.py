...
def face_detect(images):
	print(f"Starting face detection for {len(images)} frames...")
	...
	last_rect = None
	# First pass: find a valid initial rect if it exists
	...
	if last_rect is None:
		raise ValueError('Face not detected in ANY frame! Ensure the video contains a face.')
